                ...
                if (line.Contains("|"))
                {
                    using (StreamReader reader = new StreamReader(fileName))
                        while ((line = reader.ReadLine()) != null)
                        {
                            ...
                            if (pipeRecord.Gender.Trim().ToUpper() == "F" || pipeRecord.Gender.Trim().ToUpper() == "FEMALE")
                            {
                ...
                else if (line.Contains(","))
                {
                    using (StreamReader reader = new StreamReader(fileName))
                        while ((line = reader.ReadLine()) != null)
                        {
                            ...
                            if (commaRecord.Gender.Trim().ToUpper() == "F" || commaRecord.Gender.Trim().ToUpper() == "FEMALE")
                            {
                ...
                else
                {
                    using (StreamReader reader = new StreamReader(fileName))
                        while ((line = reader.ReadLine()) != null)
                        {
                            ...
                            if (spaceRecord.Gender.Trim().ToUpper() == "F" || spaceRecord.Gender.Trim().ToUpper() == "FEMALE")
                            {
